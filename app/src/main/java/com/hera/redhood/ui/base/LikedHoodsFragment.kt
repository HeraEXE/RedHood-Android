...
class LikedHoodsFragment : Fragment() {
    // views.
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        // Setting views.
        _view = inflater.inflate(R.layout.fragment_liked_hoods, container, false)
        recycler = _view.findViewById(R.id.liked_hoods_recycler)
        progressBar = _view.findViewById(R.id.liked_hoods_progress_bar)
        ...
        val listener = object : ValueEventListener {
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                for (child in snapshot.children) {
                    ...
                    if (user.likedHoods?.contains(hood.idKey)!!) {
    ...
    class Behavior(private val user: User,
        ...
        fun addUser(uid: String, userAuthor: User) {
            users[uid] = userAuthor
        }
    }
}